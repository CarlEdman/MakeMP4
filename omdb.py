...
parser.add_argument('--type', '-t', type=str, choices=['movie', 'series', 'episode'], help='show type')
...
if args.title  : q['t'] = args.title

if args.imdbid : q['i'] = args.imdbid
if args.year   : q['y'] = str(args.year)
if args.season : q['Season'] = str(args.season)
if args.episode: q['Episode'] = str(args.episode)
if args.type:
  q['type'] = args.type
elif args.episode:
  q['type'] = 'episode'
